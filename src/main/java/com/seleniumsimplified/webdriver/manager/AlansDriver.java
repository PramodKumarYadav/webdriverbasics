 ...
 */
public class AlansDriver extends Thread{
        ...
        if(aDriver==null){
            ...
            try{
                ...
                if(avoidRecursiveCall){
                    ...
                    throw new RuntimeException("something has gone wrong as we have been in AlansDriver.get already");
                }
    ...
    So I added a method called currentBrowser to AlansDriver which returns the Browser
    in use.

    I can still find out what currentDriver is with `AlansDriver.currentDriver`.
    But if I want to know the browser, I should use `AlansDriver.currentBrowser()`
    ...
    public static BrowserName currentBrowser(){
        ...
        if(currentDriver == AlansDriver.BrowserName.GRID){
    ...
    public static WebDriver get(String aURL, boolean maximize){
        ...
        if(maximize){
            try{
                ...
                System.out.println("Remote AlansDriver does not support maximise");
